...
class StatsDashboard(QWidget):
    ...
    def create_ranking_column(self, title, dataset, game_lookup, reset_badge=None):
        column_frame = QFrame()
    ...
    def refresh_stats(self, all_games):
        ...
        now = time.time()
        week_start, week_end, week_start_dt, week_end_dt = self.get_period_bounds("week")
        month_start, month_end, month_start_dt, month_end_dt = self.get_period_bounds("month")
        year_start, year_end, year_start_dt, year_end_dt = self.get_period_bounds("year")
